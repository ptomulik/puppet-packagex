...
describe Puppet::Util::PTomulik::Packagex::Portsx::PortRecord do

#  it { described_class.should be_a Puppet::Util::PTomulik::Packagex::Portsx::Functions }
  it { described_class.should < Puppet::Util::PTomulik::Packagex::Portsx::Record }
