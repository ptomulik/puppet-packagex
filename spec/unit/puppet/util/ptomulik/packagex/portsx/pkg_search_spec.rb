...
describe Puppet::Util::PTomulik::Packagex::Portsx::PkgSearch do
  let(:test_class) do
    Class.new do
      extend Puppet::Util::PTomulik::Packagex::Portsx::PkgSearch
      def self.to_s; 'Pupept::Util::PTomulik::Packagex::Portsx::PkgSearchTest'; end
