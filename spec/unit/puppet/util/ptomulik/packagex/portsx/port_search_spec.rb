...
describe Puppet::Util::PTomulik::Packagex::Portsx::PortSearch do
  let(:test_class) do
    Class.new do
      extend Puppet::Util::PTomulik::Packagex::Portsx::PortSearch
      def self.to_s; 'Pupept::Util::PTomulik::Packagex::Portsx::PortSearchTest'; end
  ...
  it { test_class.should be_a Puppet::Util::PTomulik::Packagex::Portsx::Functions }
    ...
    [
      ...
      [
        ...
        [
          [
            'www/apache22',
            Puppet::Util::PTomulik::Packagex::Portsx::PortRecord[{
              :portorigin => 'www/apache22',
            }]
          ]
        ],
  ...
  describe "#execute_make_search(key,pattern,fields=PORT_SEARCH_FIELDS,options={})" do
    ...
    [
      ...
      context "#execute_make_search(#{key.inspect},#{pattern.inspect},#{fields.inspect})" do
        ...
        let(:result) { result }
        it do
          record_class = Puppet::Util::PTomulik::Packagex::Portsx::PortRecord
